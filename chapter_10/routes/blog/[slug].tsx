...
const mockPosts: BlogPost[] = [
  {
    ...
    `,
    excerpt:
      "Learn the fundamental concepts of Fresh and why it's different from other frameworks.",
  ...
  },
  {
    ...
    `,
    excerpt:
      "A detailed comparison between Server-Side Rendering and Client-Side Rendering.",
